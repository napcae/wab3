...
Da bereits ca. 15\% der Bevölkerung in Deutschland an immer wiederkehrenden Schlafstörungen leiden und dem steigenden Interesse an Quantified Self[Vergleich(Vgl.) \ref{ch:Grundlagen:sec:QuantifiedSelf}], sind Gründe für immer mehr der sogenannten „Sleep Tracker“ auf dem Markt. %\cite{•}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.47\textwidth}
    ...
    \caption{Sleep Cycle Alarm \cite{fig:SCAlarm}}
    \label{fig:SCAlarm}
  \end{minipage}
  \begin{minipage}[t]{0.47\textwidth}
    \centering
